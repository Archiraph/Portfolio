      ...
      >
        ...
        >
          <div className="project-description">
            <p>
              Site répertoriant des utilisateurs fictifs, leur nom, prénom, date
              de naissance et jours depuis l'inscription sur le site.
              <br />
              <br />
              Ce projet utilise l'API: https://randomuser.me/api/?results=24
            </p>
          </div>
        </motion.div>
        <NavLink
          to="https://github.com/Archiraph/RandomUserApp"
          className="navlink"
          target="_blank"
        >
          <div id="code-box">
        ...
        <NavLink
          to="https://random-user-app-livid.vercel.app/"
          className="navlink"
          target="_blank"
        >
          <div id="site-box">
