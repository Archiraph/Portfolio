  ...
  return (
    <div className="project">
      ...
      >
        ...
        >
          <div className="project-description">
            <p>
              ...
              <br />
              <br />
              Le site permet à l'utilisateur de calculer un prix selon les dates
              qu'il sélectionne. Ce projet empêche aussi tout "bug" comme la
              sélection d'une date antérieure au départ pour le retour.
            </p>
          </div>
        </motion.div>
        <NavLink
          to="https://github.com/Archiraph/Date-Calculator"
          className="navlink"
          target="_blank"
        >
          <div id="code-box">
        ...
        <NavLink
          to="https://date-calculator-sand.vercel.app/"
          className="navlink"
          target="_blank"
        >
          <div id="site-box">
