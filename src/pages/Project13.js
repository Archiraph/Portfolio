      ...
      >
        ...
        >
          <div className="project-description">
            <p>
              Mini-projet permettant de mettre un compte à rebours avec un bruit
              de cloche à la fin.
            </p>
          </div>
        </motion.div>
        <NavLink
          to="https://github.com/Archiraph/Compte---Rebours"
          className="navlink"
          target="_blank"
        >
          <div id="code-box">
        ...
        <NavLink
          to="https://compte-rebours-beige.vercel.app/"
          className="navlink"
          target="_blank"
        >
          <div id="site-box">
