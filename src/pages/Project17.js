      ...
      >
        ...
        >
          <div className="project-description">
            <p>
              Site permettant de rechercher des recettes en fonction de
              l'ingrédient tapé dans la barre de recherche.
              <br />
              <br />
              Ce projet utilise l'API: https://www.themealdb.com /api/json
              /v1/1/search.php?s=
            </p>
          </div>
        </motion.div>
        <NavLink
          to="https://github.com/Archiraph/mealApp"
          className="navlink"
          target="_blank"
        >
          <div id="code-box">
        ...
        <NavLink
          to="https://meal-app-kohl.vercel.app/"
          className="navlink"
          target="_blank"
        >
          <div id="site-box">
