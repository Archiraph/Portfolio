      ...
      >
        ...
        >
          <div className="project-description">
            <p>
              Ce site permet de créer un mot de passe en sélectionnant des
              paramètres.
              <br />
              <br />
              Une fois généré, le mot de passe est directement copié.
            </p>
          </div>
        </motion.div>
        <NavLink
          to="https://github.com/Archiraph/password-maker"
          className="navlink"
          target="_blank"
        >
          <div id="code-box">
