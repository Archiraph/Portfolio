      ...
      >
        ...
        >
          <div className="project-description">
            <p>
              Site permettant de faire une recherche des pays du monde en
              fonction des paramètres sélectionnés.
              <br />
              <br />
              Ce projet utilise l'API: https://restcountries.com /v3.1/all
            </p>
          </div>
        </motion.div>
        <NavLink
          to="https://github.com/Archiraph/Country-App"
          className="navlink"
          target="_blank"
        >
          <div id="code-box">
        ...
        <NavLink
          to="https://country-app-lovat.vercel.app/"
          className="navlink"
          target="_blank"
        >
          <div id="site-box">
